...
class LoadFactOperator(BaseOperator):
    """
    Copies data from staging tables to songplays fact table.

    :param string  redshift_conn_id: reference to a specific redshift database
    :param string  table_name: redshift table to load
    :param string  insert_sql: 'select' statement used to extract songplays data
    ...
    def execute(self, context):
        ...
        self.log.info(f"StageToRedshiftOperator insert complete - {self.table_name}")
